...
<body
	...
	<div align="center">
		<form action="${path }/book/addBook" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<td>名称：</td>
					<td><input type="text" name="book.bookName" class="el-input__inner"></td>
				...
				<tr>
					<td>出版时间：</td>
					<td><input type="date" name="book.publishTime" class="el-input__inner"></td>
					<td>内容简介：</td>
				...
				<tr>
					<td>印刷时间：</td>
					<td><input type="date" name="book.printTime" class="el-input__inner"></td>
					<td>作者简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.authorAbstract"></textarea></td>
				</tr>
				<tr>
					<td>销量：</td>
					<td><input type="text" name="book.saleCount" class="el-input__inner"></td>
					<td></td>
				</tr>
				<tr>
					<td>ISBN：</td>
	...
	<script>
		function upload_review() {
			var img = document.getElementById("uploadimg");<%-- 正在 --%>
