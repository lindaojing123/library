	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<div class="cart gray4012">
				<a href="${pageContext.request.contextPath}/front/cart/cartList.jsp">购物车</a>
			</div>
		</div>
		<span class="head_toutext" id="logininfo">
		<b>您好，<${sessionScope.user.nickName}>欢迎光临当当网</b>
		[&nbsp;<a href="${pageContext.request.contextPath}/userView/leaveOut" class="b">登出</a>&nbsp;]
		[&nbsp;<a href="${pageContext.request.contextPath}/front/user/loginForm.jsp" class="b">登录</a>|
		<a href="${pageContext.request.contextPath}/front/user/registerForm.jsp" class="b">注册</a>&nbsp;]
		</span>
	</div>
