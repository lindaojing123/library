			...
			<div class="enter_in">
				...
				<div class="center">
					...
					<div class="main">
						...
						<form method="post" action="${pageContext.request.contextPath}/userView/login" id="ctl00">
							<ul>
								<li>
					...
					<div class="user_new">
						...
						<p class="set_up">
							<a href="${pageContext.request.contextPath}/front/user/registerForm.jsp">创建一个新用户&gt;&gt;</a>
						</p>
					</div>
				</div>
			</div>
