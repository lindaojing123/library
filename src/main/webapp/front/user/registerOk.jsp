		...
		<div class="login_success">
			<div class="login_bj">
				...
				<ul>
					...
					<li>
						进入“
						<a href="${pageContext.request.contextPath}/front/user/loginForm.jsp">我的当当</a>”查看并管理您的个人信息
					</li>
					<li>
						<a href="${pageContext.request.contextPath}/main/show">浏览并选购商品</a>
					</li>
				</ul>
			</div>
		</div>
