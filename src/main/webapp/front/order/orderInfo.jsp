...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
                ...
                <c:forEach items="${sessionScope.cart}" var="cartItem">
					<tr>
						...
						<td valign="top">
							${cartItem.value.book.ddPrice}
						</td>
						<td valign="top">
							${cartItem.value.num}
						</td>
						<td valign="top">
							${cartItem.value.totalPrice}
						</td>
					</tr>
				</c:forEach>
				<!-- 订单结束 -->
			...
			<br />
			<div class="login_in">
				<a href="${pageContext.request.contextPath}/front/cart/cartList.jsp">
					<input  class="button_1" name="submit" type="submit" value="取消" />
				</a>
				<a href="${pageContext.request.contextPath}/order/addressForm">
